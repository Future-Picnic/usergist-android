package studio.usergist.feedback.internal.lifecycle
...
internal class AppLifecycleObserver(
    ...
    fun start() {
        ...
        try {
            ...
            UserGistLogger.w("AppLifecycleObserver.start failed", e)
        }
    }
    ...
    fun stop() {
        ...
        try {
            ...
            UserGistLogger.w("AppLifecycleObserver.stop failed", e)
        }
    }
    ...
    override fun onStart(owner: LifecycleOwner) {
        try {
            ...
            UserGistLogger.w("AppLifecycleObserver.onStart handler threw", e)
        }
    }
    ...
    override fun onStop(owner: LifecycleOwner) {
        try {
            ...
            UserGistLogger.w("AppLifecycleObserver.onStop handler threw", e)
        }
    }
