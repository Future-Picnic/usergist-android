...
import studio.usergist.feedback.internal.model.ArmedTriggersResponse
 ...
 * [studio.usergist.feedback.internal.Config.triggerSyncIntervalMs] via
...
internal class RulesCache(
    ...
    fun bootstrapFromDisk() {
        ...
        if (parsed != null) {
            ...
            UserGistLogger.d("RulesCache bootstrap: ${parsed.triggers.size} triggers from disk")
        }
    }
    ...
    suspend fun refresh(
        ...
        UserGistLogger.d("RulesCache refresh: ${response.triggers.size} triggers")
        true
    }
