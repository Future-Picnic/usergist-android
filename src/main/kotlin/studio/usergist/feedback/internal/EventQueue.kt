...
internal class EventQueue(
    ...
    fun enqueue(event: IngestEvent): Boolean {
        val line = try {
            ...
            UserGistLogger.w("EventQueue.enqueue encode failed for ${event.name}", e)
            return false
        }
        synchronized(lock) {
            ...
            try {
                ...
                UserGistLogger.w("EventQueue.enqueue failed", e)
                return false
            }
        }
    }
    ...
    private fun sizeLocked(): Int {
        ...
        try {
            ...
            UserGistLogger.w("EventQueue.sizeLocked failed", e)
        }
        cachedSize = count
        return count
    }
    ...
    private fun discardStaleLocked() {
        try {
            ...
            UserGistLogger.w("EventQueue.discardStaleLocked failed", e)
        }
        cachedSize = 0
    }
