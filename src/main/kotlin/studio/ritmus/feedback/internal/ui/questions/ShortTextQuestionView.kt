...
internal class ShortTextQuestionView(
    ...
    override val view: View = LayoutInflater.from(context)
        .inflate(R.layout.ritmus_question_short_text, FrameLayout(context), false)

    private val layout: TextInputLayout = view as TextInputLayout
    private val input: TextInputEditText = view.findViewById(R.id.ritmus_short_text_input)
